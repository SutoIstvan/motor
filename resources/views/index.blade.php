...
<html lang="hu">
<head>
    <title>Márka Motor center - Motor adás vétel Paks</title>
    <meta name="description" content="Vállalkozásunk használt nagy motorokkal, új robogókkal, teljes körű szerviz, műszaki és eredetiség vizsga, biztosítás, átírás lebonyolításával várja ügyfeleit!">
...
<body>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                {{-- <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu drop-down-content" style="min-width: 0rem !important; left: -19px !important;">
                                        <ul class="list-unstyled drop-down-pages">
                                            <li class="nav-item">
                                                <a class="dropdown-item nav-link" target="_blank" href="https://www-markamotor-hu.translate.goog/?_x_tr_sl=hu&_x_tr_tl=de&_x_tr_hl=de&_x_tr_pto=sc&_x_tr_sch=http">
                                                    <span class="fi fi-de"></span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="dropdown-item nav-link" target="_blank" href="https://www-markamotor-hu.translate.goog/?_x_tr_sl=hu&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=sc&_x_tr_sch=http">
                                                    <span class="fi fi-gb"></span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="dropdown-item nav-link"  target="_blank" href="https://www-markamotor-hu.translate.goog/?_x_tr_sl=hu&_x_tr_tl=ro&_x_tr_hl=ro&_x_tr_pto=sc&_x_tr_sch=http">
            ...
            <div class="row aos-init aos-animate" >
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="team_member-content">
                        <h6 class="mb-4 mt-3">Motorok szűrése</h6>
                    </div>
                </div>
            </div>
                        ...
                        <a href="{{ route('motor.show', $motor) }}" style="text-decoration: none; color: inherit;">
                            ...
                            <div class="tile">
                                <div class="wrapper">
                                    ...
                                    <div class="dates">
                                        <div class="start">
                                            <div class="card-title" style="min-height: 50px;">{{ $motor->name }}</div>
                                            <div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="services_content"  data-aos="fade-right">
                        ...
                        <div class="btn_wrapper">
                            <a class="text-decoration-none get_started_btn" href="{{ route('help') }}">Részletek</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="row" data-aos="fade-up">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <a href="{{ route('help') }}#panelsStayOpen-collapse1">
                                <div class="services_box_wrapper">
                                    ...
                                    <h7 style="color: #212529">{{ $index->service1 }}</h7>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <a href="{{ route('help') }}#panelsStayOpen-collapse2">
                                <div class="services_box_wrapper">
                                    <figure>
                                    ...
                                    <h7 style="color: #212529">{{ $index->service2 }}</h7>
                                    <!-- <a href="./services.html">
                                    <i class="fa-solid fa-arrow-right"></i>
                                </a> -->
                                </div>
                    ...
                    <div class="row" data-aos="fade-up">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <a href="{{ route('help') }}#panelsStayOpen-collapse3">
                                <div class="services_box_wrapper">
                                    <figure>
                                    ...
                                    <h7 style="color: #212529">{{ $index->service3 }}</h7>
                                    <!-- <a href="./services.html">
                                    <i class="fa-solid fa-arrow-right"></i>
                                </a> -->
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <a href="{{ route('help') }}#panelsStayOpen-collapse4">
                                <div class="services_box_wrapper">
                                    <figure>
                                        <svg width="63" height="63" fill="#d74949" viewBox="0 0 32 32" data-name="Layer 1"
                                            id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                    ...
                                    <h7 style="color: #212529">{{ $index->service4 }}</h7>
    ...
    <section class="our_process_section" id="process">
        ...
        <section class="team_member_section" data-aos="fade-up">
            <div class="btn_wrapper mt-5">
                <a class="text-decoration-none viewall_btn" href="https://www.google.com/search?hl=ru-UA&gl=ua&q=Paks,+M%C3%A1rka+Motorcenter+Bt.,+Ny%C3%A1rfa+u.+2,+7030+%D0%92%D0%B5%D0%BD%D0%B3%D1%80%D0%B8%D1%8F&ludocid=4904950856099759102&lsig=AB86z5XAKSEz5cNZQDmAIgE_AtTp#lrd=0x47425c5fe20dd68d:0x4411e2d0ea9303fe,3" target="_blank">
                    Hozzászólni
                </a>
            </div>
        </section>
    ...
    <div class="container">
        ...
        <section class="team_member_section" data-aos="fade-up">
            <div class="btn_wrapper mt-5">
                <a class="text-decoration-none viewall_btn" href="/about">
                    Bővebben
                </a>
            </div>
        </section>
