                ...
                <nav class="d-flex justify-content-end">
                    ...
                    <div class="col-3">
                        ...
                        <div class="">
                            <select class="form-select" id="floatingSelectGrid" onchange="changeOrder()">
                                ...
                                <option value="year_asc" {{ request('order') == 'year_asc' ? 'selected' : '' }}>Év (a legalacsonyabb előbb)</option>
                                <option value="year_desc" {{ request('order') == 'year_desc' ? 'selected' : '' }}>Év (a legmagasabb először)</option>
                    ...
                    <div class="col-1 ms-3">
                        <div class="">
                            ...
                            {{-- <select class="form-select" id="floatingSelectGrid" onchange="change()">
                                <option selected>25</option>
                                <option value="asc">50</option>
                                <option value="desc">75</option>
                                <option value="name_asc">100</option>
                            </select> --}}
                            {{-- <label for="floatingSelectGrid">Válassza ki a sorrendet</label> --}}
                        </div>
                    </div>
                                            ...
                                            <div class="wrapper d-flex justify-content-between">
                                                ...
                                                <div class="dates col-8">
                                                    <div class="start" style="padding: 0px 20px 0px 20px">
                                                        ...
                                                        <div class="dates" style="color: #727272; height:80px">
                                                            <div>
                                                                Egyéb opciók:{{ Str::limit($motor->short_description, 90) }}
                                                            </div>
                                                        </div>

                                                        <div class="stats" style="align-self: flex-end;">
                                                            <div>
