...
@section('content')
    ...
    <div class="row ">
        <div class="col-sm-4">
            <a href="{{ route('admin.help.create') }}" class="btn btn-success mb-3">
                <i class="fas fa-plus-square"></i> Menüpont hozáadasa
            </a>
        </div>
        <div class="col-sm-8">
            @if (session('success'))
    ...
    <div class="card">
        <div class="card-header">
            <div class="conteiner">
                <div class="">
                    <h3 class="card-title">Hasznos lista</h3>
                </div>
                    ...
                    @foreach ($helps as $help)
                        <tr>
                            ...
                            <td style="width: 120px">
                                ...
                                <form method="POST" action="{{ route('admin.help.destroy', $help->id) }}">
                                    @csrf
                                    @method('DELETE')
