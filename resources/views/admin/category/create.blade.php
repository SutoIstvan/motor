...
@section('content')
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title mt-1">Kivitel hozáadasa</h3>
        </div>
        ...
        <form action="{{ route('admin.category.store') }}" method="POST" class="form-horizontal">
            ...
            <div class="card-body mt-3">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="category" class="form-control" id="category" value="{{ old('category') }}"
                            placeholder="Ad meg a kivitel nevét" maxlength="50" minlength="3" required>
                    </div>
                </div>
            </div>
