...
<head>
    <title>@yield('title', 'Márka Motor center')</title>
    <meta name="description" content="@yield('description' , 'Vállalkozásunk használt nagy motorokkal, új robogókkal, teljes körű szerviz, műszaki és eredetiség vizsga, biztosítás, átírás lebonyolításával várja ügyfeleit!')">
